<strong>1️⃣ What is the difference between var, let, and const?</strong> <br><br>
...
new array containing the modified value. The original array remains the same.

forEach() is used to loop through every element in an array and execute a function for each element. 
It does not return a new array. It is mainly used when the goal is simply to perform an action with each element.
